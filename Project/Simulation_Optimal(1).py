...
class InventorySystem:
    def __init__(self, env, r, Q,  L, m, K, h, c, w, p, demand_params):
        self.env = env
        self.r = r
        self.Q = Q
        self.L = L
...
def objective_function(x, params):
    r, Q = x
    return run_simulation((r, Q, params, 20000, 5))
...
def scatter_search(solutions, bounds, objective_function, pool, cache): # solutions to be the initial solutions
    new_solutions = []
    ...
    # return top5 solutions vector without objective function
...
if __name__ == '__main__':
    ...
    # Set up parameters
    params = {
        'L': 1, 'm': 3, 'K': 100, 'h': 1, 'c': 5, 'w': 5, 'p': 20,
...
best_r, best_Q = best_solution
validated_cost = run_simulation((best_r, best_Q, params, 20000, validation_replications))
...
env.run(until=50000)  # Run for a longer time to get more stable statistics
